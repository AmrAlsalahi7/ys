...
class ProjectPosts extends StatelessWidget {
                ...
                SingleChildScrollView(
                  ...
                  child: Row(
                    children: [
                      ...
                      ButtonYOSR(
                          function: () {}, text: 'مشاريع الأسكان ', width: 120),
                      SizedBox(
                        width: 3,
                      ),
                      ButtonYOSR(
                          function: () {}, text: 'كفالة الأيتام ', width: 120),
                      SizedBox(
                        width: 3,
                      ),
                      ButtonYOSR(
  ...
  Widget buildProjectPost(DataPost dataPost, BuildContext context) {
    return Column(
      children: [
        Padding(
                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      child:dataPost.imagePost!.isEmpty ? Image.asset('assets/images/yosrlogo.jpg'):
